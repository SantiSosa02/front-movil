...
class _IndexScreenState extends State<IndexScreen> {
  ...
  Future<void> fetchProductos() async {
    try {
      setState(() {
        _isLoading = true; // Establece isLoading en true al iniciar la carga
      });
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _isLoading = false; // Establece isLoading en false al completar la carga
        });
      ...
      setState(() {
        _isLoading = false; // Establece isLoading en false si hay un error en la carga
      });
    }
  }
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _isLoading // Muestra el CircularProgressIndicator si isLoading es true
